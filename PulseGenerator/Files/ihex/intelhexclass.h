...
class intelhex {
    ...
    private:
        ...
        ***********************************************************************/
        map<uint32_t, unsigned char> ihContent;
        ...
        ***********************************************************************/
        map<uint32_t, unsigned char>::iterator ihIterator;
        ...
        * than once.
        ***********************************************************************/
        pair<map<uint32_t, unsigned char>::iterator,bool> ihReturn;
        ...
        ***********************************************************************/
        ...
        /***********************************************************************   
        * \brief Converts an uint32_t to a string in HEX format.
        *
        ...
        ***********************************************************************/
        string ulToHexString(uint32_t value);
        ...
        ***********************************************************************/
        ...
        /**********************************************************************/
        /*! \brief Converts an uint32_t to a string in DEC format.
        *
        * Takes the received paramter and converts it into its equivalent value
        ...
        ***********************************************************************/
        string ulToString(uint32_t value);
    ...
    public:
        ...
        ***********************************************************************/
        uint32_t size()
		{
            return static_cast<uint32_t>(ihContent.size());
		}
        ...
        ***********************************************************************/
        bool endOfData()
        {
            ...
            if (!ihContent.empty())
            {
                map<uint32_t, unsigned char>::iterator it \
					                                         = ihContent.end();
        ...
        *                     valid
        ***********************************************************************/
        bool startAddress(uint32_t * address)
        {
            if (ihContent.size() != 0)
            {
                map<uint32_t, unsigned char>::iterator it;
        ...
        * \sa startAddress()
        ***********************************************************************/
        bool endAddress(uint32_t * address)
        {
            if (ihContent.size() != 0)
            {
                map<uint32_t, unsigned char>::reverse_iterator rit;
        ...
        * \sa putData()
        ***********************************************************************/
        bool getData(unsigned char * data, uint32_t address)
		{
			bool found = false;
            map<uint32_t, unsigned char>::iterator localIterator;
        ...
        ***********************************************************************/
        ...
        bool insertData(unsigned char data, uint32_t address);
        
        void overwriteData(unsigned char data);
        void overwriteData(unsigned char data, uint32_t address);
        
        bool blankFill(unsigned char data);
        
        bool blankFill(unsigned char * const data, uint32_t sizeOfData);
        
        void blankFill(unsigned char * const data, uint32_t sizeOfData,
                       uint32_t endAddress);
        
        bool blankFillRandom();
        
        void blankFillRandom(uint32_t endAddress);
        
        bool blankFillAddressLowByte();
        
        void blankFillAddressLowByte(uint32_t endAddress);
        ...
        *     setStartLinearAddress()
        ***********************************************************************/
        bool getStartLinearAddress(uint32_t * eipRegister)
        {
        ...
        ***********************************************************************/
        void setStartLinearAddress(uint32_t eipRegister)
        {
